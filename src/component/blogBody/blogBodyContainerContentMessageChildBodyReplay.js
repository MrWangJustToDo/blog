...
import BlogBodyContainerContentMessageChildBodyReplayImgCheck from "./blogBodyContainerContentMessageChildBodyReplayImgCheck";

function BlogBodyContainerContentMessageChildBodyReplay(props) {
  let ref = useRef();
  ...
  let replayHandler = useCallback(
    (e) => {
      ...
      if (ref.current.value !== "") {
        ...
        dispatch({ type: "changeChildReplayId", data: null });
      }
    },
  ...
  return (
    <form onSubmit={replayHandler}>
      <div className="form-row align-items-center">
        ...
        <BlogBodyContainerContentMessageChildBodyReplayImgCheck
          ref={checkInput}
        />
        <div className="col-2">
...
export default BlogBodyContainerContentMessageChildBodyReplay;
